...
const Copy1 = () => (
  <div>
    <p>
      In this task, you will review a number of controversial social topics where people tend to be either 
      <b>FOR</b> or <b>AGAINST</b> these issues (e.g., same-sex marriage, animal testing, etc.).
    </p>
    <p>The goal is to understand which social issues  are <b>MOST IMPORTANT TO YOU</b> and what <b>YOU BELIEVE IN</b> 
      (e.g., are you FOR or AGAINST this issue). You will be asked to complete three exercises in this task that will help us identify a final social issue that appears important to you and that you are most motivated to fight for in the next task. 
    </p>
